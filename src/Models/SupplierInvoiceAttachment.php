...
/**
 * Supplier Invoice Attachment Model
 *
 * Details on writable properties for Supplier Invoice Attachment:
 * None
 */
class SupplierInvoiceAttachment extends BaseModel
{

    /**
     * @var string $endpoint
     */
    protected $endpoint = 'SupplierInvoiceAttachment';
    ...
    public function validate()
    {
        throw new LibraryException(
            ...
            '\DarrynTen\SageOne\Models\SupplierInvoiceAttachment::validate()'
        );
    }
}
