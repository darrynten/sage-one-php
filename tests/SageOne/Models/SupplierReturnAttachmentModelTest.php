...
use DarrynTen\SageOne\Models\SupplierReturnAttachment;
...
class SupplierReturnAttachmentModelTest extends BaseModelTest
{
    public function testAttributes()
    {
        $this->verifyAttributes(SupplierReturnAttachment::class, []);
    }

    public function testFeatures()
    {
        $this->verifyFeatures(SupplierReturnAttachment::class, [
    ...
    {
        $model = new SupplierReturnAttachment($this->config);
    ...
    public function testFeatureGetException()
    {
        $model = $this->setUpRequestMock(
            'GET',
            SupplierReturnAttachment::class,
            'SupplierReturnAttachment/Get/1',
            'SupplierReturnAttachment/GET_SupplierReturnAttachment_Get_xx.json'
        );
        ...
        $this->expectExceptionMessage('Model "SupplierReturnAttachment" Received namespaced class "DarrynTen\SageOne\Models\InvalidClass" which does not exist Property is referencing an undefined, non-primitive class');
    ...
    public function testFeatureGetExceptionUnimplemented()
    {
        ...
        $this->expectExceptionMessage('Error, "DarrynTen\SageOne\Models\SupplierReturnAttachment:get()" Method not yet implemented. This still needs to be added, please consider contributing to the project');
    ...
    {
        $this->verifyGetId(SupplierReturnAttachment::class, 1, function ($collection) {
    ...
    public function testDownload()
    {
        $model = $this->setUpRequestMock(
            'GET',
            SupplierReturnAttachment::class,
            'SupplierReturnAttachment/Download/c37fbc7d-0a09-4990-9a55-b889f6699617',
            'files/test.png'
        );
    ...
    public function testGetCompanyStorageInformation()
    {
        $model = $this->setUpRequestMock(
            'GET',
            SupplierReturnAttachment::class,
            'SupplierReturnAttachment/GetCompanyStorageInformation',
            'SupplierReturnAttachment/GET_SupplierReturnAttachment_GetCompanyStorageInformation.json'
        );
    ...
    {
        $this->verifyDelete(SupplierReturnAttachment::class, 'c37fbc7d-0a09-4990-9a55-b889f6699617', true);
    }

    public function testDeleteFail()
    {
        $this->verifyDelete(SupplierReturnAttachment::class, 'c37fbc7d-0a09-4990-9a55-b889f6699617', false);
    }
    ...
    public function testDeleteAll()
    {
        $model = $this->setUpRequestMock(
            'DELETE',
            SupplierReturnAttachment::class,
            'SupplierReturnAttachment/DeleteAll/c37fbc7d-0a09-4990-9a55-b889f6699617',
            null,
            null,
            [],
            204
    ...
    public function testAllowDelete()
    {
        $model = $this->setUpRequestMock(
            'GET',
            SupplierReturnAttachment::class,
            'SupplierReturnAttachment/AllowDelete/c37fbc7d-0a09-4990-9a55-b889f6699617',
            'SupplierReturnAttachment/GET_SupplierReturnAttachment_AllowDelete.json'
        );
    ...
    public function testAllowDeleteFail()
    {
        $model = $this->setUpRequestMock(
            ...
            SupplierReturnAttachment::class,
            'SupplierReturnAttachment/AllowDelete/c37fbc7d-0a09-4990-9a55-b889f6699617',
            'SupplierReturnAttachment/GET_SupplierReturnAttachment_AllowDelete_Fail.json'
        );
    ...
    public function testValidate()
    {
        ...
        $this->expectException(LibraryException::class);
        $this->expectExceptionMessage('Error, "\DarrynTen\SageOne\Models\SupplierReturnAttachment::validate()" Method not yet implemented. This still needs to be added, please consider contributing to the project..');
        $this->expectExceptionCode(10301);
