...
/**
 * Supplier Return Attachment Model
 *
 * Details on writable properties for Supplier Return Attachment:
 * None
 */
class SupplierReturnAttachment extends BaseModel
{

    /**
     * @var string $endpoint
     */
    protected $endpoint = 'SupplierReturnAttachment';
    ...
    public function validate()
    {
        throw new LibraryException(
            ...
            '\DarrynTen\SageOne\Models\SupplierReturnAttachment::validate()'
        );
    }
}
